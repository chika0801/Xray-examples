...
> Mux 配置只需在[客户端](v2rayNG_custom_fakedns.json#L103-L108)启用，服务端自动适配
...
> MPTCP 配置需在[客户端](v2rayNG_custom_fakedns.json#L98-L101)，[服务端](VLESS-Vision-TLS/config_server_without_fallback.json#L46-L49)同时启用<br>
